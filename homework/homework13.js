...
const countChars = (string) => {
    ...
    for (let i = 0; i < string.length; i++) {
      let char = string[i].toLowerCase();
      if (alphabet.includes(char)) obj.letters++;
      else if (Number(char)) {
        obj.numbers++;
      }
    }
...
const romanToInt = (string) => {
  let result = 0;
  for (let i = 0; i <= string.length; i++)
    if (string.at(i) === "M") result += 1000;
    else if (string.at(i) === "D") result += 500;
    else if (string.at(i) === "C") result += 100;
    else if (string.at(i) === "L") result += 50;
    else if (string.at(i) === "X") result += 10;
    else if (string.at(i) === "V") result += 5;
    else if (string.at(i) === "I") result += 1;
